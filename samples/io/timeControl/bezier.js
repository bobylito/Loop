...
(function(){
  ...
  loop.addIO( Loop.io.controlTime(80000) );
  ...
  for(var i = 0; i < 30; i++){
    ...
    loop.registerAnimation(createBlob({y: window.loop.height + 60 * i/3 , x: randX}, 5*randSizeFactor, 20*randSizeFactor, 20*randSizeFactor));
  }
