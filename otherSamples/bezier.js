...
loop.addIO(Loop.io.controlTime);
...
for(var i = 0; i < 100; i++){
    ...
    loop.registerAnimation(createBlob({y: window.loop.height + 60 * i, x: randX}, 5*randSizeFactor, 20*randSizeFactor, 20*randSizeFactor));
}
